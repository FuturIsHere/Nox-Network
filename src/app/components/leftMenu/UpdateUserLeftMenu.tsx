// UpdateUserLeftMenu.tsx mis à jour
"use client"
...
const UpdateUserLeftMenu = ({ user }: { user: User }) => {
    ...
    const getPreviewUrl = (uploadResult: any) => {
        ...
        if (typeof url === 'string' && url) {
            console.log('📷 [UpdateUserLeftMenu] URL prévisualisation:', url);
            return url;
        }
        
        console.warn('⚠️ [UpdateUserLeftMenu] Format d\'upload inattendu:', uploadResult);
        return user.cover || "/noAvatar.png";
    };
    ...
    const handleUploadSuccess = (result: any) => {
        console.log('📎 [UpdateUserLeftMenu] Upload réussi:', result);
        ...
        console.log('📷 [UpdateUserLeftMenu] Données cover:', coverData);
        setCover(coverData);
    };

    return (
        <>
            {/* Seulement l'image cliquable - le texte sera géré par le parent */}
            <div
                className="transition-transform duration-200 hover:scale-110 cursor-pointer w-full h-full flex items-center justify-center"
                ...
                >
                    <form
                        ...
                        action={(formData) => {
                            ...
                            console.log('🚀 [UpdateUserLeftMenu] Soumission avec cover:', coverUrl);
...
export default UpdateUserLeftMenu